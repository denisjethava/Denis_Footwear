...
{
    public partial class Sandle : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void btnprice1_Click(object sender, EventArgs e)
        {
            ...
            string ChappleSandle = lblSandle.Text;
            ...
            else
            {
                ...
                string query = "INSERT INTO Sandles (Chapple,Size, Quantity, Price,Total) VALUES (@Chapple,@Size, @Quantity, @Price,@Total)";
                cmd = new SqlCommand(query, con);

                cmd.Parameters.AddWithValue("@Chapple", ChappleSandle);
                ...
                try
                {
                    ...
                    if (res > 0)
                    {
                        Response.Redirect($"BillPage.aspx?Chapple={ChappleSandle}&Size={SelectedSize}&Quantity={SelectedQuantity}&Price={price}&Total={total}");
