...
{
    public partial class Kolapuri : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void btnprice1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "INSERT INTO Kolapuri (Chapple,Size, Quantity, Price,Total) VALUES (@Chapple,@Size, @Quantity, @Price,@Total)";
                cmd = new SqlCommand(query, con);

                cmd.Parameters.AddWithValue("@Chapple", ChappleKol);
                ...
                try
                {
                    ...
                    if (res > 0)
                    {
                        Response.Redirect($"BillPage.aspx?Chapple={ChappleKol}&Size={SelectedSize}&Quantity={SelectedQuantity}&Price={price}&Total={total}");
