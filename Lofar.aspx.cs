...
{
    public partial class Lofar : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd;
        ...
        protected void btnprice1_Click(object sender, EventArgs e)
        {
            ...
            string ChappleLofars = lblLofar.Text;
            ...
            else
            {
                ...
                string query = "INSERT INTO Lofars (Chapple,Size, Quantity, Price,Total) VALUES (@Chapple,@Size, @Quantity, @Price,@Total)";
                cmd = new SqlCommand(query, con);

                cmd.Parameters.AddWithValue("@Chapple", ChappleLofars);
                ...
                try
                {
                    ...
                    if (res > 0)
                    {
                        Response.Redirect($"BillPage.aspx?Chapple={ChappleLofars}&Size={SelectedSize}&Quantity={SelectedQuantity}&Price={price}&Total={total}");
